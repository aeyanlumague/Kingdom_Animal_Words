...
public class Activity17 extends AppCompatActivity {
    ...
    private String[] keys = {"D","U","C","K","S","T"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aboutBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog Description = new AlertDialog.Builder(Activity17.this).create();

                Description.setMessage("ANAS - has a torpedo shape body, rounded head, and slightly flattened and rounded bill..");
    ...
    private void doValidate() {
        ...
        if(editText.getText().toString().equals(textAnswer)){
            Toast.makeText(Activity17.this, "Correct", Toast.LENGTH_SHORT).show();
            editText.setText("");
            nextBtn = findViewById(R.id.nextBtn);
            nextBtn.setVisibility(View.VISIBLE);
        }else {
            Toast.makeText(Activity17.this, "Wrong", Toast.LENGTH_SHORT).show();
            editText.setText("");
        }
        keys = shuffleArray(keys);
