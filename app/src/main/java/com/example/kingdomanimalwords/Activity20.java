...
public class Activity20 extends AppCompatActivity {
    ...
    private String[] keys = {"F","O","X","S","H","J"};
    private String textAnswer = "FOX";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MediaPlayer bgmusic = MediaPlayer.create(Activity20.this,R.raw.sparkle);
                bgmusic.start();
                finish();
            }
        });
        ...
        aboutBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog Description = new AlertDialog.Builder(Activity20.this).create();

                Description.setMessage("VULPES VULPES - is the largest of the true foxes and one of the most widely distributed members of the order carnivora.");
    ...
    private void doValidate() {
        ...
        if(editText.getText().toString().equals(textAnswer)){
            Toast.makeText(Activity20.this, "Correct", Toast.LENGTH_SHORT).show();
            editText.setText("");
            nextBtn = findViewById(R.id.nextBtn);
            nextBtn.setVisibility(View.VISIBLE);
        }else {
            Toast.makeText(Activity20.this, "Wrong", Toast.LENGTH_SHORT).show();
            editText.setText("");
        }
        keys = shuffleArray(keys);
