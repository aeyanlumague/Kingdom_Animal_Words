...
public class Activity32 extends AppCompatActivity {
    ...
    private String[] keys = {"S","H","A","R","K","T"};
    private String textAnswer = "SHARK";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Activity32.this, Activity33.class);
                startActivity(intent);
                MediaPlayer bgmusic = MediaPlayer.create(Activity32.this,R.raw.sparkle);
                bgmusic.start();
                finish();
            }
        });
    ...
    private void doValidate() {
        ...
        if(editText.getText().toString().equals(textAnswer)){
            Toast.makeText(Activity32.this, "Correct", Toast.LENGTH_SHORT).show();
            editText.setText("");
            nextBtn = findViewById(R.id.nextBtn);
            nextBtn.setVisibility(View.VISIBLE);

        }else {
            Toast.makeText(Activity32.this, "Wrong", Toast.LENGTH_SHORT).show();
            editText.setText("");
        }
        keys = shuffleArray(keys);
