...
public class Activity15 extends AppCompatActivity {
    ...
    private String[] keys = {"D","O","N","K","E","Y"};
    private String textAnswer = "DONKEY";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MediaPlayer bgmusic = MediaPlayer.create(Activity15.this,R.raw.sparkle);
                bgmusic.start();
                finish();
            }
        });
        ...
        aboutBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog Description = new AlertDialog.Builder(Activity15.this).create();

                Description.setMessage("EQUUS ASINUS - is a domesticated member of the family Horse.");
    ...
    private void doValidate() {
        ...
        if(editText.getText().toString().equals(textAnswer)){
            Toast.makeText(Activity15.this, "Correct", Toast.LENGTH_SHORT).show();
            editText.setText("");
            nextBtn = findViewById(R.id.nextBtn);
            nextBtn.setVisibility(View.VISIBLE);
        }else {
            Toast.makeText(Activity15.this, "Wrong", Toast.LENGTH_SHORT).show();
            editText.setText("");
        }
        keys = shuffleArray(keys);
