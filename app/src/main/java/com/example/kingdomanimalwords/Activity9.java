...
public class Activity9 extends AppCompatActivity {
    ...
    private String[] keys = {"H","O","R","S","E","A"};
    private String textAnswer = "HORSE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MediaPlayer bgmusic = MediaPlayer.create(Activity9.this,R.raw.sparkle);
                bgmusic.start();
                finish();
            }
        });
        ...
        aboutBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog Description = new AlertDialog.Builder(Activity9.this).create();

                Description.setMessage("EQUUS CABALLUS - have long necks, long legs, and singular solid hooves on the ends of their feet.");
    ...
    private void doValidate() {
        ...
        if(editText.getText().toString().equals(textAnswer)){
            Toast.makeText(Activity9.this, "Correct", Toast.LENGTH_SHORT).show();
            editText.setText("");
            nextBtn = findViewById(R.id.nextBtn);
            nextBtn.setVisibility(View.VISIBLE);
        }else {
            Toast.makeText(Activity9.this, "Wrong", Toast.LENGTH_SHORT).show();
            editText.setText("");
        }
        keys = shuffleArray(keys);
