...
public class Activity14 extends AppCompatActivity {
    ...
    private String[] keys = {"D","O","G","N","R","Y"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MediaPlayer bgmusic = MediaPlayer.create(Activity14.this,R.raw.sparkle);
                bgmusic.start();
                finish();
            }
        });
        ...
        aboutBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog Description = new AlertDialog.Builder(Activity14.this).create();

                Description.setMessage("CANIS LUPUS FAMILIARIS - is a domesticated descendant of the wolf. it is from an ancient extinct wolf, and the modern grey wolf is the nearest living relative.");
    ...
    private void doValidate() {
        ...
        if(editText.getText().toString().equals(textAnswer)){
            Toast.makeText(Activity14.this, "Correct", Toast.LENGTH_SHORT).show();
            editText.setText("");
            nextBtn = findViewById(R.id.nextBtn);
            nextBtn.setVisibility(View.VISIBLE);
        }else {
            Toast.makeText(Activity14.this, "Wrong", Toast.LENGTH_SHORT).show();
            editText.setText("");
        }
        keys = shuffleArray(keys);
