...
public class Activity28 extends AppCompatActivity {
    ...
    private String[] keys = {"P","I","G","L","C","V"};
    private String textAnswer = "PIG";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MediaPlayer bgmusic = MediaPlayer.create(Activity28.this,R.raw.sparkle);
                bgmusic.start();
                finish();
            }
        });
        ...
        aboutBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog Description = new AlertDialog.Builder(Activity28.this).create();

                Description.setMessage("SUS - are mammals with stocky bodies, flat snouts that can move independently of their heads, small eyes and large ears.");
    ...
    private void doValidate() {
        ...
        if(editText.getText().toString().equals(textAnswer)){
            Toast.makeText(Activity28.this, "Correct", Toast.LENGTH_SHORT).show();
            editText.setText("");
            nextBtn = findViewById(R.id.nextBtn);
            nextBtn.setVisibility(View.VISIBLE);
        }else {
            Toast.makeText(Activity28.this, "Wrong", Toast.LENGTH_SHORT).show();
            editText.setText("");
        }
        keys = shuffleArray(keys);
